...
local function description_rules(msg, nama)
   ...
   if data[tostring(msg.to.id)] then
      ...
      local sambutan = "اهـــلاً وسهـــلاً |❤️| كبد عمري❣️🍾🍷"..nama.."\nنـــورت/ي المجموعـــــــةة☄️😻☝🏽️ '"..string.gsub(msg.to.print_name, "_", " ").."'\n|💎| اتـــبع القوانــيـن 📕 لتجنـــب الطرد😽🎩☝🏽️ \n"
      local text = sambutan.."|💎| اذا اردت 💆🏿‍♂️ اضهار القوانـــين 👨🏿‍💻 ارسـل لي القوانــيـن💔😻☝🏽️  "
      local text = text..""
      local text = text..""
      local text = text.." |💎| للخروج من المجموعـــه |⛹🏿‍♀️| ارسل لي اطردني 💔🙊☝🏽️"
      local text = text..""
      local text = text..""
      local text = text.."👇🏻]"
      local text = text..""
      local text = text.."                                               "
      local text = text.."@DEV_KEEPER_NEW☝🏿️"
      local receiver = get_receiver(msg)
...
local function run(msg, matches)
   ...
   elseif matches[1] == "chat_del_user" then
       ...
       return ' الله الله الله ويــــاك😻 لا تنــسى ســد الباب وراك|☄️|☄️| كبــد عمري ❤️❗️ '..bye_name
   end
end
